    ...
    return (function e(t, n, r) {
            ...
            1: [function (_dereq_, module, exports) {
                ...
                module.exports = function () {
                    ...
                    var warna=[
                        ".merahtomat{background:#fd6a62}",
                        ".zamrud{background:#2c8}",
                        ".hijoterang{background:#2f4}",
                        ".birulaut{background:#0ac2d2}",
